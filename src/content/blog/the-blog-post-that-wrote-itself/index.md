...
The fire must come from the writer. AI can generate fire, but it can't clear smoke.

That's the whole idea behind this blog.

## Why a Blog

I've given maybe fifteen talks in the last two years. I think colleagues at my company are probably tired of seeing me talk. But the thing with spoken words is that they vanish. They get scattered. And I wanted to have all that output together somewhere.
...
*Yes, that's me. For hours. Looking at a blank page.*
...
And finally **refine**. This is the adversarial part, a critic and an editor arguing over your draft. It deserves its own section.
...
This comes from how newsrooms work. You have a writer and an editor. You create copy, go to your editor, disagree, go back and forth. That's what we try to replicate.

![Editing meme](./editing-meme.png)
*Your typical conversation with an editor.*

We use this idea of red team and blue team, borrowed from security testing. One agent (the critic) tries to find problems with the post, always thinking about the reader experience. Then the editor defends the choices. It accepts the critiques that make sense and makes changes, but always preserving the voice of the author.
...
[Verbatim](https://github.com/jesgarram/verbatim) is open source and the pipeline is quite easy to set up. The pipeline handles the craft, but it can't give you something to say. That part is still on me.
